...
EthoInsight Frontend is a Next.js 16 web interface for an AI agent system serving behavioral researchers. It communicates with a LangGraph-based backend (forked from DeerFlow) to provide thread-based AI conversations with streaming responses, artifacts, and a skills/tools system.
