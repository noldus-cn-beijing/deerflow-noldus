...
export const enUS: Translations = {
  ...
  gallery: {
    ...
    dataSection: "Data",
    metricsTableTitle: "Metrics results",
    metricsTableExpand: "View metrics table",
    metricsTableGroupN: (n: number) => `n=${n}`,
    outlierFlag: "outlier",
    downloadCsv: "Download CSV",
    metricsTableEmpty: "No metrics results yet",
    metricsTableLoading: "Loading metrics table…",
    ...
    nFiltered: (n: number) => `Showing ${n} chart${n === 1 ? "" : "s"}`,
  },
