...
class ThreadDataMiddleware(AgentMiddleware[ThreadDataMiddlewareState]):
    ...
    def _get_thread_paths(self, thread_id: str, *, user_id: str | None = None) -> dict[str, str]:
        ...
        Args:
            ...
            user_id: Optional user ID for per-user filesystem isolation.
        ...
        return {
            ...
            "shared_path": str(self._paths.shared_dir(thread_id, user_id=user_id)),
        }
    ...
    def before_agent(self, state: ThreadDataMiddlewareState, runtime: Runtime) -> dict | None:
        ...
        if self._lazy_init:
            ...
            paths = self._get_thread_paths(thread_id, user_id=get_effective_user_id())
        else:
            # Eager initialization: create directories immediately
            paths = self._create_thread_directories(thread_id, user_id=get_effective_user_id())
