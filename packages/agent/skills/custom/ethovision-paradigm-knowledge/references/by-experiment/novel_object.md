# 实验：新物体识别 (Novel Object Recognition (NOR))

**slug**：`novel_object` （这是 paradigm key，agent 内部用）
...
- `OpenFieldRectangle-NovObjZones` —— 取舍：（待补充）
- `OpenFieldCircle-NovObjZones` —— 取舍：（待补充）
