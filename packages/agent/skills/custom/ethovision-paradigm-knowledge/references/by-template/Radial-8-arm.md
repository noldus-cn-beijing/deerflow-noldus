# EV19 大类：Radial-8-arm

**中文名**（待补充）：8 臂放射迷宫（待行为学同事确认中文）
...
## 变体：Radial-8-arm-AllZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`Radial-8-arm-AllZones`
- **arena_template**：`Radial 8-arm maze`
- **zone_template**：`Center, arm and goal zones`
...
## 变体：Radial-8-arm-NoZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`Radial-8-arm-NoZones`
- **arena_template**：`Radial 8-arm maze`
