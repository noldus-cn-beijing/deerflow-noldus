...
## 变体：WellPlate-Circle-AllZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`WellPlate-Circle-AllZones`
- **arena_template**：`Well plate, round wells`
- **zone_template**：`Border, center zone`
...
## 变体：WellPlate-Circle-NoZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`WellPlate-Circle-NoZones`
- **arena_template**：`Well plate, round wells`
...
## 变体：WellPlate-Rectangle-AllZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`WellPlate-Rectangle-AllZones`
- **arena_template**：`Well plate, square wells`
- **zone_template**：`Border, center zone`
- **bypass_arena_grid**：False
- **bypass_subject_count_and_roles**：False
- **bypass_subject_features**：False
...
## 变体：WellPlate-Rectangle-NoZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`WellPlate-Rectangle-NoZones`
- **arena_template**：`Well plate, square wells`
- **zone_template**：`No zone template`
- **bypass_arena_grid**：False
- **bypass_subject_count_and_roles**：False
