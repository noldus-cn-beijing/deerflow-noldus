...
## 变体：T-Maze-Fish-AllZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`T-Maze-Fish-AllZones`
- **arena_template**：`T-maze`
- **zone_template**：`Start box, center, arms and goal zones`
...
## 变体：T-Maze-Fish-NoZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`T-Maze-Fish-NoZones`
- **arena_template**：`T-maze`
...
## 变体：T-Maze-Rodents-Other-AllZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`T-Maze-Rodents-Other-AllZones`
- **arena_template**：`T-maze`
- **zone_template**：`Start box, center, arms and goal zones`
- **bypass_arena_grid**：False
- **bypass_subject_count_and_roles**：True
...
## 变体：T-Maze-Rodents-Other-NoZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`T-Maze-Rodents-Other-NoZones`
- **arena_template**：`T-maze`
- **zone_template**：`No zone template`
- **bypass_arena_grid**：False
- **bypass_subject_count_and_roles**：True
