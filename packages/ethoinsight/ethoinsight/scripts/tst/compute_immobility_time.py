"""TST: 不动时间 (immobility time)。

CLI: python -m ethoinsight.scripts.tst.compute_immobility_time \
...
from ethoinsight.metrics.tst import compute_immobility_time_tst
...
def main(argv: list[str] | None = None) -> int:
    ...
    value = compute_immobility_time_tst(df)
