"""TST: 不动潜伏期 (immobility latency)。

CLI: python -m ethoinsight.scripts.tst.compute_immobility_latency \
...
from ethoinsight.metrics.tst import compute_immobility_latency_tst
...
def main(argv: list[str] | None = None) -> int:
    ...
    value = compute_immobility_latency_tst(df)
