"""Zero Maze: 开放区指标组间对比箱线图。

CLI: python -m ethoinsight.scripts.zero_maze.plot_box_open_zone \
...
METRICS_TO_PLOT = ["open_zone_time_ratio", "open_zone_distance"]
...
def main(argv: list[str] | None = None) -> int:
    ...
    metrics = compute_paradigm_metrics(parsed, paradigm="zero_maze", groups=groups, zone_overrides=parse_parameters(args) or None)
