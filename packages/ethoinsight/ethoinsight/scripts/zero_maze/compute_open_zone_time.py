"""Zero Maze: 开放区总停留时间（秒） (open zone time).

CLI: python -m ethoinsight.scripts.zero_maze.compute_open_zone_time \
       --input <轨迹文件> --output <metric.json>

输出 JSON:
  {"metric": "open_zone_time", "value": <float or null>}
...
def main(argv: list[str] | None = None) -> int:
    ...
    value = compute_open_zone_time(df, **parameters)
