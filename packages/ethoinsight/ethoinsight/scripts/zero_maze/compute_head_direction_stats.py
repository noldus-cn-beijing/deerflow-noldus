"""Zero Maze: 头部朝向统计 (head direction circular stats)。

CLI: python -m ethoinsight.scripts.zero_maze.compute_head_direction_stats \
...
def main(argv: list[str] | None = None) -> int:
    ...
    value = compute_head_direction_stats(df)
