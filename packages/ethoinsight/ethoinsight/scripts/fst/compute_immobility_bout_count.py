"""FST: 不动回合数 (immobility bout count)。

CLI: python -m ethoinsight.scripts.fst.compute_immobility_bout_count \
...
from ethoinsight.metrics.fst import compute_immobility_bout_count_fst
