"""OFT: 趋触性指数 (thigmotaxis index)。

CLI: python -m ethoinsight.scripts.oft.compute_thigmotaxis_index \
       --input <轨迹文件> --output <metric.json>

输出 JSON:
  {"metric": "thigmotaxis_index", "value": <float or null>}
...
from ethoinsight.metrics.oft import compute_thigmotaxis_index
...
def main(argv: list[str] | None = None) -> int:
    ...
    value = compute_thigmotaxis_index(df, **parameters)
