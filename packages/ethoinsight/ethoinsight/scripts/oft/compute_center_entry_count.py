"""OFT: 中心区进入次数 (center entry count)。

CLI: python -m ethoinsight.scripts.oft.compute_center_entry_count \
       --input <轨迹文件> --output <metric.json>

输出 JSON:
  {"metric": "center_entry_count", "value": <int or null>}
...
METRIC_NAME = "center_entry_count"
...
def main(argv: list[str] | None = None) -> int:
    ...
    value = compute_center_entry_count(df, **parameters)
