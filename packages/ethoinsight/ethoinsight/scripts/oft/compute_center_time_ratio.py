"""OFT: 中心区时间占比 (center time ratio)。

CLI: python -m ethoinsight.scripts.oft.compute_center_time_ratio \
       --input <轨迹文件> --output <metric.json>

输出 JSON:
  {"metric": "center_time_ratio", "value": <float or null>}
