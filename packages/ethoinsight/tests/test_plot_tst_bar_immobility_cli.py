"""TST bar_immobility CLI tests: n=1 (suppresses errorbars) + n=3 multi-group."""
...
def _make_tst_df(n: int = 60) -> pd.DataFrame:
...
def test_bar_immobility_single_subject(single_subject_file: Path, tmp_path: Path):
    ...
    result = subprocess.run(
        [sys.executable, "-m", "ethoinsight.scripts.tst.plot_bar_immobility",
