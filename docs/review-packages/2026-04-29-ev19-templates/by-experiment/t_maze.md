...
**slug**：`t_maze` （这是 paradigm key，agent 内部用）

> 行为学同事补充。机器侧 ev19_template 字段在 by-template/ 里维护。

<!-- 起草备注（同事可删除）：鱼/啮齿都能用，要按物种区分 -->
...
- `T-Maze-Rodents-Other-AllZones` —— 取舍：（待补充）
- `T-Maze-Rodents-Other-NoZones` —— 取舍：（待补充）
- `T-Maze-Fish-AllZones` —— 取舍：（待补充）
- `T-Maze-Fish-NoZones` —— 取舍：（待补充）
