# EV19 大类：Cross Maze-Fish

**中文名**（待补充）：鱼用十字迷宫（待行为学同事确认中文）
...
## 变体：Cross Maze-Fish-AllZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`Cross Maze-Fish-AllZones`
- **arena_template**：`Cross maze`
...
## 变体：Cross Maze-Fish-NoZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`Cross Maze-Fish-NoZones`
- **arena_template**：`Cross maze`
