...
## 变体：Sociability-AllZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`Sociability-AllZones`
- **arena_template**：`Sociability chamber`
- **zone_template**：`Chamber and cage zones`
...
## 变体：Sociability-NoZones

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`Sociability-NoZones`
- **arena_template**：`Sociability chamber`
