# EV19 大类：UgoBasileFCS

**中文名**（待补充）：Ugo Basile 恐惧条件化（待行为学同事确认中文）
...
## 变体：UgoBasileFCS-1cubicle

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`UgoBasileFCS-1cubicle`
- **arena_template**：`Ugo Basile FCS 1 cubicle`
...
## 变体：UgoBasileFCS-4cubicles

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`UgoBasileFCS-4cubicles`
- **arena_template**：`Ugo Basile FCS 4 cubicles`
- **zone_template**：`No zone template`
