# EV19 大类：DanioVision DVOC 004x

**中文名**（待补充）：DanioVision 96 孔板（待行为学同事确认中文）
...
## 变体：DanioVision DVOC 004x-96w-circ

### 🟢 EV19 机器字段（自动抽取，请勿修改）

- **目录名**：`DanioVision DVOC 004x-96w-circ`
- **arena_template**：`DanioVision DVOC 004x, 96 round wells`
