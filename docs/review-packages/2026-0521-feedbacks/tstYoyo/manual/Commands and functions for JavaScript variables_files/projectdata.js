...
rh.consts('DEFAULT_TOPIC', encodeURI("#EthoVision_XT_19_Help/EV_Introduction/EV_Introduction.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.html"));
rh.consts('START_FILEPATH', encodeURI('index.html'));
rh.consts('HELP_ID', '12CCCCF1-4D92-48FD-A10B-F6C9E1A4C04F' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "EthoVision XT 19 Help");
model.publish(rh.consts('KEY_HEADER_TITLE_COLOR'), "#FFFFFF");
model.publish(rh.consts('KEY_HEADER_BACKGROUND_COLOR'), "#232323");
model.publish(rh.consts('KEY_HEADER_LOGO_PATH'), "template/Charcoal_GreyResponsive_HTML5/logo.png");
